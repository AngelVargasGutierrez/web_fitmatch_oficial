        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="router.php?page=login">Iniciar Sesión</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="router.php?page=register">Registrarse</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="cta-buttons">
                    <a href="router.php?page=register" class="btn btn-primary-custom">
                        <i class="fas fa-user-plus me-2"></i>Comenzar Ahora
                    </a>
                    <a href="router.php?page=login" class="btn btn-secondary-custom">
